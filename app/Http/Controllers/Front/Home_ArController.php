...
class Home_ArController extends Controller
{
    public function home(){
        ...
        return response()->view('front_ar.index_ar', compact('services','count','opinions','doctors'));
    }
    public function about(){
        return response()->view('front_ar.about_ar');
    }
    ...
    public function services(){
        ...
        $steps = Step::all();
        return response()->view('front_ar.services_ar',compact('services','sup_titles','sup_descriptions','steps'));
    }
    public function service($id){
        ...
        $sup_descriptions=SupDescription::all();
        $steps = Step::all();
        return response()->view('front_ar.service_ar',compact('id','services','sup_titles','sup_descriptions','steps'));
    ...
    public function staff(){
        ...
        return response()->view('front_ar.staff_ar',compact('doctorsCo','doctorsStaff','hospitals'));
    }

    public function contact(){
        return response()->view('front_ar.contact_ar');
    }
