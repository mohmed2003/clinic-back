  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{route('view_home')}}" class="nav-link">Home</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          ...
          <img class="img-circle elevation-2" src="{{asset('storage/images/admin/'.auth('admin')->user()->Image ?? " ")}}" width="60" height="60" alt="User Image">
        </div>
        <div class="info">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('view_home')}}" class="nav-link active">
          ...
          @canany(['Index Roles', 'Create Role', 'Index Permissions', 'Create Permission'])
         ...
         @canany(['Index Roles', 'Create Role'])
          ...
          @endcanany
          @canany(['Index Permissions', 'Create Permission'])
          <li class="nav-item">
            <a href="#" class="nav-link">
              {{-- <i class="nav-icon fas fa-user"></i> --}}
              {{-- <i class="fas fa-user"></i> --}}
              {{-- <i class="nav-icon fas fa-triangle-music"></i> --}}
          ...
          @endcanany
           @canany(['Index Admin', 'Create Admin','Index Doctor', 'Create Doctor'])
                <li class="nav-header">User Mangement</li>
          ...
          @canany(['Index City', 'Create City','Index Country', 'Create Country','Index Opinion', 'Create Opinion','Index Spachilty', 'Create Spachilty','Index Hospital', 'Create Hospital','Index Contact'])
        ...
        @canany(['Index Country', 'Create Country'])
          ...
          @endcanany
@canany(['Index Spachilty', 'Create Spachilty'])
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{route('spachilties.index')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>index</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="{{route('spachilties.create')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>create</p>
                </a>
              </li>
          ...
          @canany(['Index Hospital', 'Create Hospital'])
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{route('hospitals.create')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>create</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a href="{{route('editProfile',auth('admin')->id())}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{route('view_changePassword')}}" class="nav-link">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">@yield('sub-title','Home')</a></li>
