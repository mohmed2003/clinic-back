...
<header class="top-nav" id="header">
        ...
        <div class="navbar-content">
            ...
            <ul class="navbar-menu">
                ...
                <li class="menu-item">
                    ...
                    <a class="navbar-link active hvr-underline-from-left" href="{{route('view.index_ar')}}"> الرئيسية </a>
                ...
                <li class="menu-item">
                    ...
                    <a class="lang-btn" href="{{route('view.index')}}">
    ...
    <div class="page-wrapper">
        ...
        @section('scripts')      <!-- ***** The opinions of our customers End ***** -->
     <script>
